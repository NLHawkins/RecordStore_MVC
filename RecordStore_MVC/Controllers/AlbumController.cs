...
namespace RecordStore_MVC.Controllers
{
    public class AlbumController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BandId,Title,Genre,ReleaseDate")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BandId,Title,Genre,ReleaseDate")] Album album)
        {
            if (ModelState.IsValid)
            {
